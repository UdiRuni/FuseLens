...
Use the model a classfier for new fusion transcripts false/true-postive predication with higher accuracy and compare with other tools (i.e.Arriba, FusionScan, and GFusion, which are algorithms designed to analyze RNA sequencing data to identify split reads and other evidence of fusion transcripts).
### Impact: 
