...
tools (probably all that we will be using in the scope of this project) are available via the
Bioconda channel. Working with Conda for bioinformatics will allow you to easily install
packages and resolve dependency conflicts. Please review the [BIOCONDA](https://bioconda.github.io/) channel for
more information, and how to install it for your system.
